...
export default function AllDevices() {
    const [devices, setDevices] = useState([
        {
            name: 'temperature', status: true, icon: {
                ...
                height: '150px',
                iconHeight: '50px',
                bgNormal: '/assets/icons/temperature.svg',
                bgActive: '/assets/icons/temperature_white.svg',
            }
        },
        {
            name: 'led', status: false, icon: {
                ...
                height: '130px',
                iconHeight: '50px',
                bgNormal: '/assets/icons/led.svg',
                bgActive: '/assets/icons/led_white.svg',
            }
        },
        {
            name: 'air conditioner', status: true, icon: {
                ...
                height: '80px',
                iconHeight: '40px',
                bgNormal: '/assets/icons/spiral.svg',
                bgActive: '/assets/icons/spiral_white.svg',
            }
        },
        {
            name: 'wifi', status: false, icon: {
                ...
                height: '70px',
                iconHeight: '40px',
                bgNormal: '/assets/icons/wifi.svg',
                bgActive: '/assets/icons/wifi_white.svg',
            }
        },
        {
            name: 'humidity', status: false, icon: {
                ...
                height: '90px',
                iconHeight: '45px',
                bgNormal: '/assets/icons/humidity.svg',
                bgActive: '/assets/icons/humidity_white.svg',
            }
        },
    ]);
    ...
    return (
        <div className='space-y-8'>
            ...
            <div className="relative px-4 w-full overflow-hidden flex gap-6">
                ...
                <div className="flex-1 overflow-hidden">
                    <div className="w-full flex gap-6" style={{ transform: `translateX(${offset}px)`, transition: 'transform 0.3s ease' }}>
                        {devices.map((device) => (
                            <div
                                key={device.name}
                                className={cn("w-[200px] h-56 flex-shrink-0 px-6 py-6 rounded-3xl overflow-hidden relative flex flex-col justify-between shadow-[0_10px_38px_-28px_rgba(0,0,0,0.25)]",
                                    device.status ? 'bg-[#31ED93]' : 'bg-white'
                                )}
                            >
                                <Image src={device.status ? device.icon.bgActive : device.icon.bgNormal} height={500} width={500} alt='' className="absolute top-10 right-6 opacity-20" style={{
                                    width: 'auto',
