        ...
        <div className='w-full h-full flex flex-col gap-6'>
            ...
            <section className='flex-1 flex justify-center items-start'>
                <div className="w-full max-w-3xl grid grid-cols-2 gap-6">
                    ...
                    <div className="col-span-1 shadow-[0_10px_88px_36px_rgba(2,106,56,0.05)] px-10 py-8 rounded-3xl flex items-center justify-center gap-4">
                        <div className="w-24 h-24 rounded-full bg-[rgba(49,237,147,0.1)] flex items-center justify-center">
                            <TemperatureIcon className='w-auto h-14' />
                        </div>
                        <div className="h-full flex flex-col justify-around">
                            <p className='text-5xl font-semibold'>29°C</p>
                            <p className='text-sm text-[#9B9B9B]'>Living Room</p>
                        </div>
                    </div>
                    <div className="col-span-1 shadow-[0_10px_88px_36px_rgba(2,106,56,0.05)] px-10 py-8 rounded-3xl flex items-center justify-center gap-4">
                        <div className="w-24 h-24 rounded-full bg-[rgba(49,237,147,0.1)] flex items-center justify-center">
                            <OutsideIcon className='w-auto h-11' />
                        </div>
                        <div className="h-full flex flex-col justify-around">
                            <p className='text-5xl font-semibold'>44%</p>
                            <p className='text-sm text-[#9B9B9B]'>Outside</p>
                        </div>
                    </div>
                    <div className="col-span-1 shadow-[0_10px_88px_36px_rgba(2,106,56,0.05)] px-10 py-8 rounded-3xl flex items-center justify-center gap-4">
                        <div className="w-24 h-24 rounded-full bg-[rgba(49,237,147,0.1)] flex items-center justify-center">
                            <HumidityIcon className='w-auto h-12' />
                        </div>
                        <div className="h-full flex flex-col justify-around">
                            <p className='text-5xl font-semibold'>87 m³</p>
                            <p className='text-sm text-[#9B9B9B]'>Water</p>
                        </div>
                    </div>
                    <div className="col-span-1 shadow-[0_10px_88px_36px_rgba(2,106,56,0.05)] px-10 py-8 rounded-3xl flex items-center justify-center gap-4">
                        <div className="w-24 h-24 rounded-full bg-[rgba(49,237,147,0.1)] flex items-center justify-center">
                            <FlashIcon className='w-auto h-12' />
                        </div>
                        <div className="h-full flex flex-col justify-around">
